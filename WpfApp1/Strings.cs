...
namespace WpfApp1
{
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string[]> T = new Dictionary<string, string[]>
        {
            ...
            { "EngineDl", new string[] { "Скачать", "Download", "Завантажити", "下载", "Laden", "Télécharger", "Descargar", "Pobierz", "İndir", "Scarica" } },
            { "EngineFailed", new string[] { "Движок недоступен — включён встроенный Chromium.", "Engine unavailable — built-in Chromium enabled.", "Рушій недоступний — ввімкнено вбудований Chromium.", "引擎不可用——已切换到内置 Chromium。", "Engine nicht verfügbar — eingebautes Chromium aktiv.", "Moteur indisponible — Chromium intégré activé.", "Motor no disponible — Chromium integrado activado.", "Silnik niedostępny — włączono wbudowany Chromium.", "Motor kullanılamıyor — yerleşik Chromium açıldı.", "Motore non disponibile — Chromium integrato attivato." } },
        };
