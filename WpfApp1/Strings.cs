...
namespace WpfApp1
{
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string[]> T = new Dictionary<string, string[]>
        {
            ...
            { "Theme10", new string[] { "Янтарная", "Amber", "Бурштинова", "琥珀色", "Bernstein", "Ambre", "Ámbar", "Bursztynowy", "Amber", "Ambra" } },
            { "Theme11", new string[] { "Лаймовая", "Lime", "Лаймова", "柠檬绿", "Limette", "Citron vert", "Lima", "Limonkowy", "Limon", "Lime" } },
            { "Theme12", new string[] { "Индиго", "Indigo", "Індиго", "靛蓝色", "Indigo", "Indigo", "Índigo", "Indygo", "Lacivert", "Indaco" } },
            { "Theme13", new string[] { "Графитовая", "Slate", "Графітова", "石板灰", "Schiefer", "Ardoise", "Pizarra", "Grafitowy", "Arduvaz", "Ardesia" } },
            ...
            { "PinStart", new string[] { "Закрепить в меню Пуск", "Pin to Start", "Закріпити в меню Пуск", "固定到开始菜单", "An Start anheften", "Épingler au menu Démarrer", "Fijar al inicio", "Przypnij do Start", "Başlat'a sabitle", "Aggiungi a Start" } },
            { "PlayAfterClose", new string[] { "Играть после закрытия окна", "Keep playing after closing", "Грати після закриття вікна", "关闭后继续播放", "Nach Schließen weiterspielen", "Continuer après fermeture", "Seguir tras cerrar", "Graj po zamknięciu", "Kapatınca çalmaya devam", "Continua dopo la chiusura" } },
            { "AdBlockLbl", new string[] { "Блокировка рекламы (выкл по умолчанию)", "Ad blocking (off by default)", "Блокування реклами (вимкнено)", "广告拦截（默认关闭）", "Werbeblocker (aus)", "Blocage pub (off)", "Bloqueo de anuncios (off)", "Blokowanie reklam (wył.)", "Reklam engelleme (kapalı)", "Blocco annunci (off)" } },
            { "SiteAnims", new string[] { "Анимации на сайте", "Site animations", "Анімації на сайті", "网站动画", "Website-Animationen", "Animations du site", "Animaciones del sitio", "Animacje strony", "Site animasyonları", "Animazioni sito" } },
            { "ReDesign", new string[] { "SoundCloud ReDesign (бета)", "SoundCloud ReDesign (beta)", "SoundCloud ReDesign (бета)", "SoundCloud ReDesign（测试）", "SoundCloud ReDesign (Beta)", "SoundCloud ReDesign (bêta)", "SoundCloud ReDesign (beta)", "SoundCloud ReDesign (beta)", "SoundCloud ReDesign (beta)", "SoundCloud ReDesign (beta)" } },
            { "PlayerPopup", new string[] { "Окно плеера при старте трека", "Player window on track start", "Вікно плеєра при старті треку", "播放时弹出播放器窗口", "Player-Fenster bei Trackstart", "Fenêtre lecteur au démarrage", "Ventana al iniciar tema", "Okno odtwarzacza przy starcie", "Parça başlayınca pencere", "Finestra player all'avvio" } },
            { "ExtGroup", new string[] { "Расширения браузера", "Browser extensions", "Розширення браузера", "浏览器扩展", "Browser-Erweiterungen", "Extensions navigateur", "Extensiones", "Rozszerzenia", "Tarayıcı uzantıları", "Estensioni" } },
            { "ExtAdd", new string[] { "Добавить из папки…", "Add from folder…", "Додати з папки…", "从文件夹添加…", "Aus Ordner hinzufügen…", "Ajouter depuis dossier…", "Añadir desde carpeta…", "Dodaj z folderu…", "Klasörden ekle…", "Aggiungi da cartella…" } },
            { "ExtDel", new string[] { "Убрать", "Remove", "Прибрати", "移除", "Entfernen", "Retirer", "Quitar", "Usuń", "Kaldır", "Rimuovi" } },
            { "ExtOk", new string[] { "Расширение поставлено.", "Extension installed.", "Розширення встановлено.", "扩展已安装。", "Erweiterung installiert.", "Extension installée.", "Extensión instalada.", "Zainstalowano.", "Uzantı kuruldu.", "Estensione installata." } },
            { "PlayerTitle", new string[] { "Сейчас играет", "Now playing", "Зараз грає", "正在播放", "Läuft gerade", "Lecture en cours", "Sonando ahora", "Teraz gra", "Şimdi çalıyor", "In riproduzione" } },
            { "PlayerToTray", new string[] { "Свернуть в трей", "Minimize to tray", "Згорнути в трей", "最小化到托盘", "In Tray minimieren", "Réduire dans la barre", "Minimizar a bandeja", "Minimalizuj do zasobnika", "Tepsiye küçült", "Riduci nel tray" } },
            { "TrayHidden", new string[] { "Музыка играет в фоне. Кликни по иконке, чтобы вернуть окно.", "Music keeps playing. Click the icon to bring the window back.", "Музика грає у фоні. Клацни по іконці, щоб повернути вікно.", "音乐在后台播放，点击图标恢复窗口。", "Musik läuft weiter. Klicke aufs Icon.", "La musique continue. Clique sur l'icône.", "La música sigue. Clic en el icono.", "Muzyka gra w tle. Kliknij ikonę.", "Müzik arka planda. Pencere için simgeye tıkla.", "La musica continua. Clicca sull'icona." } },
            { "RdTitle", new string[] { "Настройки редизайна", "ReDesign options", "Налаштування редизайну", "重新设计设置", "ReDesign-Optionen", "Options ReDesign", "Opciones de ReDesign", "Opcje ReDesign", "ReDesign seçenekleri", "Opzioni ReDesign" } },
            { "RdOpen", new string[] { "Настроить редизайн…", "Tune the redesign…", "Налаштувати редизайн…", "调整重新设计…", "ReDesign anpassen…", "Régler ReDesign…", "Ajustar ReDesign…", "Dostosuj ReDesign…", "ReDesign ayarla…", "Regola ReDesign…" } },
            { "RdCards", new string[] { "Карточки треков", "Track cards", "Картки треків", "曲目卡片", "Track-Karten", "Cartes de titres", "Tarjetas de temas", "Karty utworów", "Parça kartları", "Schede brani" } },
            { "RdButtons", new string[] { "Кнопки", "Buttons", "Кнопки", "按钮", "Buttons", "Boutons", "Botones", "Przyciski", "Düğmeler", "Pulsanti" } },
            { "RdHeader", new string[] { "Шапка сайта", "Site header", "Шапка сайту", "网站顶栏", "Website-Kopf", "En-tête du site", "Cabecera del sitio", "Nagłówek strony", "Site başlığı", "Intestazione sito" } },
            { "RdPlayer", new string[] { "Нижний плеер", "Bottom player", "Нижній плеєр", "底部播放器", "Player-Leiste", "Lecteur du bas", "Reproductor inferior", "Dolny odtwarzacz", "Alt oynatıcı", "Lettore in basso" } },
            { "RdComments", new string[] { "Комментарии", "Comments", "Коментарі", "评论", "Kommentare", "Commentaires", "Comentarios", "Komentarze", "Yorumlar", "Commenti" } },
            { "RdSidebar", new string[] { "Боковая панель", "Sidebar", "Бічна панель", "侧边栏", "Seitenleiste", "Panneau latéral", "Panel lateral", "Panel boczny", "Yan panel", "Pannello laterale" } },
            { "RdInputs", new string[] { "Поля ввода", "Inputs", "Поля вводу", "输入框", "Eingabefelder", "Champs", "Campos", "Pola", "Girdiler", "Campi" } },
            { "RdPopups", new string[] { "Окна и меню", "Popups and menus", "Вікна і меню", "弹窗和菜单", "Fenster und Menüs", "Fenêtres et menus", "Ventanas y menús", "Okna i menu", "Pencereler ve menüler", "Finestre e menu" } },
            ...
            { "SetupNoFiles", new string[] { "Нет файлов для установки: рядом нет папки app и пейлоад не вшит.", "Nothing to install: no app folder nearby and no embedded payload.", "Немає файлів для встановлення: поруч немає папки app і пейлоад не вшито.", "没有可安装的文件：附近没有 app 文件夹，也没有嵌入 payload。", "Nichts zu installieren: kein app-Ordner daneben, keine eingebettete Payload.", "Rien à installer : pas de dossier app, pas de payload intégré.", "Nada que instalar: no hay carpeta app ni payload integrado.", "Brak plików do instalacji: brak folderu app i wbudowanego payloadu.", "Kurulacak dosya yok: app klasörü yok ve payload gömülü değil.", "Niente da installare: nessuna cartella app, nessun payload integrato." } },
        };
